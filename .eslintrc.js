module.exports = {
	...
	"rules": {
		...
		"complexity": [1, 20],               // specify the maximum cyclomatic complexity allowed in a program (off by default)
		...
		"no-underscore-dangle": [2, {"allow": ["_id"]}], // disallow dangling underscores in identifiers
